...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.init_angvel.setFont(font2)
        ...
        self.init_altitude.setFont(font2)
        ...
        self.trim_time_start.setFont(font2)
