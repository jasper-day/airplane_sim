...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_trim_btn.setFont(font3)
        ...
        self.del_prev_trim_btn.setFont(font3)
        ...
        self.clear_trims_btn.setFont(font3)
        ...
        self.run_simulation_btn.setFont(font4)
        ...
        self.graph_selector.setFont(font3)
...
#if QT_CONFIG(shortcut)
        self.del_prev_trim_btn.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Del", None))
#endif // QT_CONFIG(shortcut)
        self.clear_trims_btn.setText(QCoreApplication.translate("MainWindow", u"Clear All", None))
#if QT_CONFIG(shortcut)
        self.clear_trims_btn.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+Del", None))
#endif // QT_CONFIG(shortcut)
        self.run_simulation_btn.setText(QCoreApplication.translate("MainWindow", u"Run Simulation", None))
#if QT_CONFIG(shortcut)
        self.run_simulation_btn.setShortcut(QCoreApplication.translate("MainWindow", u"Shift+Return", None))
#endif // QT_CONFIG(shortcut)
