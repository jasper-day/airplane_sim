...
# class calcwidget(QWidget):
    def __init__(self, parent=None):
        ...
        layout.addWidget(self.graph,2,0)
        layout.addWidget(self.graph,3,0)
        layout.addWidget(self.graph,0,1)
        layout.addWidget(self.graph,1,1)
        layout.addWidget(self.graph,2,1)
        layout.addWidget(self.graph,3,1)
...
class Window2(QMainWindow):                           # <===
    def __init__(self, parent = None):
        ...
        # self.w2_calcwidget = calcwidget(self)
        self.w2_mainlayout = QGridLayout()

        self.graph1 = TestGraph()
        self.graph2 = TestGraph()
        self.graph3 = TestGraph()
        self.graph4 = TestGraph()
        self.graph5 = TestGraph()
        self.graph6 = TestGraph()
        self.graph7 = TestGraph()
        self.graph8 = TestGraph()

        self.w2_mainlayout.addWidget(self.graph1,0,0)
        self.w2_mainlayout.addWidget(self.graph2,1,0)
        self.w2_mainlayout.addWidget(self.graph3,2,0)
        self.w2_mainlayout.addWidget(self.graph4,3,0)
        self.w2_mainlayout.addWidget(self.graph5,0,1)
        self.w2_mainlayout.addWidget(self.graph6,1,1)
        self.w2_mainlayout.addWidget(self.graph7,2,1)
        self.w2_mainlayout.addWidget(self.graph8,3,1)
        
        # self.w2_mainlayout.addWidget(self.w2_calcwidget,0,0,4,2)
        self.Homebutton = QPushButton("Back to Menu", self)
        self.Homebutton.clicked.connect(self.mainwindow)
        self.w2_mainlayout.addWidget(self.Homebutton,4,0,1,2)
