...
import sys
sys.path.insert(0,r'C:\Users\thoma\OneDrive - University of Edinburgh\Year 3\Computational Methods and Modelling 3\airplane_sim\GUI')
from GUI.Page_1 import (Page_Alpha, AlphaTable, AlphaGraph)
...
# to design the layouts.
    ...
    def init_widgets(self):
        self.stack_widget.addWidget(Page_Alpha)
        self.show()
